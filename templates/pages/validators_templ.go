...
func validatorMeetsSlaThreshold(report *db.SlaNodeReport) bool {
...
func validatorUptimeColor(report *db.SlaNodeReport) string {
...
type ValidatorsProps struct {
	...
	ValidatorUptimeMap map[string][]*db.SlaNodeReport
	CurrentPage        int32
	HasNext            bool
	HasPrev            bool
	PageSize           int32
